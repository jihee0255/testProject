...
import static com.example.myproject.Sub1.selItem;


public class MyRecyclerviewAdapter extends
        RecyclerView.Adapter<com.example.myproject.Adapter.MyRecyclerviewAdapter.ItemViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull ItemViewHolder holder, final int position) {//데이터 연결
